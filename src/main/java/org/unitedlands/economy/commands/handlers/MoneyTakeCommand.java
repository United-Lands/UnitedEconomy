...
public class MoneyTakeCommand extends BaseCommandHandler<UnitedEconomy> {

    public MoneyTakeCommand(UnitedEconomy plugin, IMessageProvider messageProvider) {
    ...
    public void handleCommand(CommandSender sender, String[] args) {
        ...
        var newBalance = BankAccountManager.instance().withdraw(targetPlayer.getUniqueId(), targetPlayer.getName(), amount,
                null, currency.getKey());

        Messenger.sendMessage(player, messageProvider.get("messages.take"),
                Map.of("name", args[0],
