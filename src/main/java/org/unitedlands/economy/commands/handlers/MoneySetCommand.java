...
public class MoneySetCommand extends BaseCommandHandler<UnitedEconomy> {

    public MoneySetCommand(UnitedEconomy plugin, IMessageProvider messageProvider) {
    ...
    public void handleCommand(CommandSender sender, String[] args) {
        ...
        Messenger.sendMessage(player, messageProvider.get("messages.set"),
                Map.of("name", args[0],
